...
public class WebConstants {
    ...
    public static final String RESOURCE_FOLDER_PATH = System.getProperty("user.dir") +
            File.separator + "src" +
            File.separator + "resources";
    public static final String ASSETS_FOLDER_PATH = File.separator + "assets";
    public static final String PAGES_FOLDER_PATH = File.separator + "pages";
}
